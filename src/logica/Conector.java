...
public class Conector {
   ...
   public Connection conecta() {
       ...
       try{
         ...
         conn = DriverManager.getConnection("jdbc:mysql://maorivera.com:3306/maoriver_cobat","maoriver_cobat","Barbara2401");
         //conn = DriverManager.getConnection("jdbc:mysql://localhost/gonac_mecanico","root","");
         //si la conexion tuvo exito
         if (conn!=null){
            System.out.println("Conexión a base de datos Cobat");
